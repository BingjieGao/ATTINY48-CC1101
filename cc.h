...
//  CC1101
//
//  Created by Davide on 26/01/2016.
//  Copyright © 2016 catamo. All rights reserved.
//
 ...
 */
    ...
    extern byte spisend(byte value);
     ...
     * 'len'	Data length
     */
    extern void readBurstReg(byte * buffer, byte regAddr, byte len);
     ...
     */
    extern void setRegsFromEeprom(void);
    ...
    extern void writeBurstReg(byte regAddr, byte* buffer, byte len);
     ...
     * 'cmd'	Command strobe
     */
    extern void cmdStrobe(byte cmd);
     ...
     */
    extern byte readReg(byte regAddr, byte regType);
     ...
     */
    extern void writeReg(byte regAddr, byte value);
     ...
     * 'save' If TRUE, save parameter in EEPROM
     */
    extern void setChannel(byte chnl, bool save);
     ...
     */
    extern void setPowerDownState(void);
     ...
     *    False otherwise
     */
    extern bool sendData(struct CCPACKET packet);
     ...
     */
    extern byte receiveData(struct CCPACKET *packet);
    extern void setSyncWordbytes(byte *sync, bool save);
